...
ActiveRecord::Schema.define(version: 20_221_114_111_432) do
  ...
  create_table 'company_activity_days', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[company_id activity_day], name: 'index_unique_company_activity_days', unique: true
  ...
  create_table 'company_arts', force: :cascade do |t|
    ...
    t.index %w[company_id art_id], name: 'index_company_arts_on_company_id_and_art_id', unique: true
  ...
  create_table 'company_athletics', force: :cascade do |t|
    ...
    t.index %w[company_id athletic_id], name: 'index_company_athletics_on_company_id_and_athletic_id', unique: true
  ...
  create_table 'company_cultures', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[company_id culture_id], name: 'index_company_cultures_on_company_id_and_culture_id', unique: true
  ...
  create_table 'company_keywords', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[company_id keyword_id], name: 'index_company_keywords_on_company_id_and_keyword_id', unique: true
  ...
  create_table 'company_places', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[company_id place], name: 'index_unique_company_places', unique: true
